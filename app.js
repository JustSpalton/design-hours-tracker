...
function renderWeeks(){const sel=document.getElementById('weekSelect');sel.innerHTML='';allWeeks().slice().reverse().forEach(k=>{const o=document.createElement('option');o.value=k;o.textContent=`W/C ${fmtDate(k)}`;o.selected=k===selectedWeek;sel.appendChild(o)})}
